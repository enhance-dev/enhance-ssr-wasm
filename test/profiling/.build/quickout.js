(() => {
  ...
  // test/profiling/mock-harness.mjs
  function mock_harness_default(input = {}) {
    let container = input || {};
    const Host2 = {
    ...
    _ssr({ Host: Host2, Config: Config2 });
